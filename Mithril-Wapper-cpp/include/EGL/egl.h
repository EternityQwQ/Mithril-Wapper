...
/*
 * Minimal EGL 1.5-compatible public header for Mithril-Wapper.
 *
 * Mithril-Wapper ships its own EGL implementation backed by Metal 2 (see
 * ../egl/egl.cpp). This header provides the EGL types, enum tokens and
